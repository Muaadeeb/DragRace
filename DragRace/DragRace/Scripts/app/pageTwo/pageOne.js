var randomNumberGenerator = function (min, max) {
    var someValue = Math.random() * (max - min) + min;
...
//}
var LOL = 56;
var winChance = function () {
    var lostPoint3 = LOL - 3;
    var losePoint6 = LOL - 6;
    var winPoint3 = LOL + 3;
    var winPoint6 = LOL + 6;
};
//document.getElementById("pointsSpent").innerHTML = totalCCP.toString();
//switch (randomNumberGenerator) {
//    case (randomNumberGenerator < .25):
//        alert("Lose 6");
//        break;
//    case (randomNumberGenerator > .26 && x < .5):
//        alert("Lose 3 ");
//        break;
//    case (randomNumberGenerator > .51 && x < .75):
//        alert("Win 3");
//        break;
//    case (randomNumberGenerator > .76 && x < 1):
//        alert("Win 6");
//        break;
//    default:
//        alert("none");
